...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/architecture_4.jpg" alt="Architecture">
      <div class="carousel-caption d-none d-md-block">
             <h3>Architecture</h3>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/nature_4.jpg" alt="Nature">
      <div class="carousel-caption d-none d-md-block">
             <h3>Nature</h3>
        </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/travel_5.jpg" alt="Travel">
      <div class="carousel-caption d-none d-md-block">
             <h3>Travel</h3>
        </div>
    </div>
...
<section class="my-4">
    ...
    <div class="col-lg-4 col-md-4 col-12">
        <img src="images/travel_6.jpg" class="img-fluid pb-3">
    </div>
    </div>
    </div>
</section>
...
<section class="my-4">
    <div class="py-4">
        <h2 class="text-center">Contact Alon</h2>
    </div>
...
<section class="my-4">
    ...
    <div class="container-fluid">
        ...
        <p class="text-center"><b>I am a passinate Developer And Sex Machine Monster!</b></p>
    </div>
